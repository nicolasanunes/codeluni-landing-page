                ...
                <div class="swiper-wrapper">
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <div class="client-info d-flex align-items-center mt-4">
                        <img src="../public/assets/img/person/person-f-1.webp" class="client-img" alt="Client" loading="lazy">
                        <div>
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <div class="client-info d-flex align-items-center mt-4">
                        <img src="../public/assets/img/person/person-m-1.webp" class="client-img" alt="Client" loading="lazy">
                        <div>
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <div class="client-info d-flex align-items-center mt-4">
                        <img src="../public/assets/img/person/person-f-2.webp" class="client-img" alt="Client" loading="lazy">
                        <div>
                  ...
                  <div class="swiper-slide">
                    <div class="testimonial-item">
                      ...
                      <div class="client-info d-flex align-items-center mt-4">
                        <img src="../public/assets/img/person/person-f-3.webp" class="client-img" alt="Client" loading="lazy">
                        <div>
      ...
      <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="advertise-1 d-flex flex-column flex-lg-row gap-4 align-items-center position-relative">
          ...
          <div class="content-right position-relative" data-aos="fade-left" data-aos-delay="300">
            <img src="../public/assets/img/misc/misc-1.webp" alt="Digital Platform" class="img-fluid rounded-4">
                ...
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="../public/assets/img/person/person-m-7.webp" class="profile-img" alt="">
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="../public/assets/img/person/person-m-7.webp" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="../public/assets/img/person/person-f-8.webp" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Sara Wilsson</h3>
                        <span>Designer</span>
                      </div>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="../public/assets/img/person/person-f-8.webp" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="../public/assets/img/person/person-m-9.webp" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Matt Brandon</h3>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="../public/assets/img/person/person-m-9.webp" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="../public/assets/img/person/person-f-10.webp" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Jena Karlis</h3>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="../public/assets/img/person/person-f-10.webp" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
